...
import { SoundEffect, SoundConfig } from '../types.js';
...
export class SoundManager {
   ...
   */
  private _createGain(ctx: AudioContext): GainNode {
   ...
   */
  private _playSelect(ctx: AudioContext): void {
   ...
   */
  private _playPromotion(ctx: AudioContext): void {
   ...
   */
  private _playLose(ctx: AudioContext): void {
    const notes = [
      { freq: 392, time: 0 },    // G4
